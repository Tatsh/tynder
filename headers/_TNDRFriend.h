...
@property BOOL matchmakerMatchPendingValue;
@property(readonly, nonatomic) TNDRFriendID *objectID;
@property BOOL onTinderValue;
...
- (void)setPrimitiveMatchmakerMatchPendingValue:(BOOL)arg1;
- (void)setPrimitiveOnTinderValue:(BOOL)arg1;
