...
+ (void)load;
- (int)bk_addButtonWithTitle:(id)arg1 handler:(CDUnknownBlockType)arg2;
@property(copy, nonatomic, setter=bk_setCancelBlock:) CDUnknownBlockType bk_cancelBlock;
- (CDUnknownBlockType)bk_handlerForButtonAtIndex:(int)arg1;
- (id)bk_initWithTitle:(id)arg1;
- (int)bk_setCancelButtonWithTitle:(id)arg1 handler:(CDUnknownBlockType)arg2;
- (int)bk_setDestructiveButtonWithTitle:(id)arg1 handler:(CDUnknownBlockType)arg2;
- (void)bk_setHandler:(CDUnknownBlockType)arg1 forButtonAtIndex:(int)arg2;
